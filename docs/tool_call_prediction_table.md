...
| 仓库 | PR | 文件 | +行 | -行 | 熟悉 | 陌生 | 最坏 |
|------|-----|------|-----|-----|------|------|------|
| facebook/react | [Flight] Render to object | 47 | 6192 | 204 | 97 | 230 | 460 |
| kubernetes/kubernetes | Upgrade grpc v1.82.1 | 66 | 589 | 364 | 71 | 168 | 336 |
| grafana/grafana | folder-scope opt-out | 55 | 435 | 405 | 64 | 152 | 303 |
| astral-sh/uv | Bump version 0.11.30 | 151 | 401 | 366 | 149 | 356 | 711 |
| vercel/next.js | Instant Insights timing | 21 | 576 | 155 | 32 | 75 | 150 |

### 模拟 150+ 场景

| 场景 | 文件 | +行 | -行 | 熟悉 | 陌生 | 最坏 | 工具分布 |
|------|------|-----|-----|------|------|------|---------|
| OAuth2 + RBAC 系统 | 30 | 3500 | 500 | 63 | 151 | 302 | bash:166 read:36 edit:54 write:30 |
| REST→GraphQL 迁移 | 45 | 2500 | 1800 | 74 | 176 | 352 | bash:194 read:42 edit:63 write:35 |
| 实时 WebSocket 协作 | 35 | 4500 | 300 | 75 | 178 | 357 | bash:196 read:43 edit:64 write:36 |
| 分布式缓存层 | 25 | 2000 | 400 | 47 | 112 | 224 | bash:123 read:27 edit:40 write:22 |
| 关键 RCE 漏洞修复 | 18 | 900 | 150 | 29 | 69 | 138 | bash:76 read:17 edit:25 write:14 |
| 多租户数据隔离 | 40 | 5000 | 800 | 85 | 204 | 407 | bash:224 read:49 edit:73 write:41 |
| React 17→18 升级 | 60 | 1500 | 1200 | 75 | 178 | 356 | bash:196 read:43 edit:64 write:36 |
| 流式 SSE API | 20 | 1800 | 200 | 40 | 96 | 191 | bash:105 read:23 edit:34 write:19 |
